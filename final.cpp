...
class domestic: public customer{
    ...
    void calcseat(){
        a = 'A';
        cout<<"First      Business         Economy\n";
        cout<<"Class       Class            Class\n";
        cout<<"   ";
        for(int m=1;m<16;m++){
            if(m==2||m==6||m==13){cout<<m<<"     ";}
            else if(m>9){cout<<m<<" ";}
            else{cout<<m<<"  ";}
        }
        cout<<endl;
        ...
        try{
            ...
            while(c>15 || c<0){
                cout<<"Enter column number again ";
                cin>>c;
            }
        }
        catch(char r){
...
void showflights(char ch){
   string check;
    ...
    flights fl;
    cout<<"   Initial | Final |  Price | Date of flight\n";
    cout<<"---------------------------------------\n";
    while(getline(i,check)){
        cout<<c<<" : "<<check<<endl;
        c++;
                ...
                while(1){
                    ...
                    switch(ch){
                        case 1:{
                            ...
                            while(check=='n'){
                                dom.display();
                                cout<<"\nCheck whether you have entered the right details(y/n):\n";
                                cin>>check;
                                if(check=='n'){
                            ...
                            dom.calprice();
                            dom.writeinfiledom();
                            cout<<"Do you want to confirm ticket?(y/n):";
                            cin>>p;
                            if(p=='y'){
                                cout<<"\n\n      ***TICKET***   "<<endl;
                                dom.displayd();
